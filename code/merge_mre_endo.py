...
extracted_data_path = "/home/minkyoon/2023_CLAM_MUTLIMODAL/code/mre_merged.csv"
new_output_path = "/home/minkyoon/2023_CLAM_MUTLIMODAL/code/endo22.csv"
...
# extracted_data_df['slide_id'] = extracted_data_df['slide_id'].astype(int)
# new_output_df['slide_id'] = new_output_df['slide_id'].astype(int)

# 'ID'와 'slide_id'를 기준으로 두 데이터프레임을 병합 (inner join 사용)
merged_df = pd.merge(extracted_data_df, new_output_df, on='ID', how='inner')
