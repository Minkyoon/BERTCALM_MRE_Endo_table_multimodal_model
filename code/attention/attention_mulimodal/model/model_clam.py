...
class CLAM_endo(nn.Module):
    ...
    def forward(self, h,  label=None, instance_eval=False, return_features=False, attention_only=False):
        ...
        return aggregated_output, A, results_dict,
...
class MultimodalModel(nn.Module):
    ...
    def forward(self, endo_data, mre_data, tabular_data, label=None):
        ...
        endo_feat, endo_attention = self.endo_attention(endo_feat)
        
        # MRE 
        mre_feat, A_raw_mre, results_dict_mre  = self.mre_model(mre_data, label=label)
        mre_feat, mre_attention = self.mre_attention(mre_feat)
        
        # tabualr    
        tabular_feat, tabular_attention = self.tabular_attention(tabular_data)
        ...
        return output, results_dict_endo, results_dict_mre, A_raw_endo, A_raw_mre, endo_attention, mre_attention, tabular_attention
