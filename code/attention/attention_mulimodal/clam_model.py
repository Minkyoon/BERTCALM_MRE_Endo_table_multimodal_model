...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, image_feature, table_feature):
        ...
        for i in range(self.num_heads):
            ...
            score_image.append(image_attention_score)
        ...
        return multi_head_feature, score, score_image
...
class CLAM_SB(nn.Module):
    ...
    def forward(self, h, tabular, label=None, instance_eval=False, return_features=False, attention_only=False):
        ...
        concat,score, score_image = self.attention_module(M, tabular)
        
        print(type(score_image))
        print(type(score))
        ...
        return logits, Y_prob, Y_hat, A_raw, results_dict, A, score, score_image